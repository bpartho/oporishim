        ...
        <div className="relative z-10 flex h-full items-center mt-6">
          <div className="container mx-auto px-4 lg:px-2">
            <div className="max-w-3xl text-white">
              <h1 className="text-2xl font-bold leading-relaxed md:leading-snug -tracking-normal md:text-3xl lg:text-5xl">
                Experience Next-Level Business Performance with Our SaaS Trio
              </h1>
